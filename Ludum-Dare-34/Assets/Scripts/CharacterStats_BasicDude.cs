...
public class CharacterStats_BasicDude : CharacterStats {

    private int healthStore;
    private float forceMultiplierStore;
    private float damageStore;

    public CharacterStats_BasicDude(int health, float force, float damage) : base(health, force, damage)
    {
        health = healthStore;
    ...
    {
        base.health -= amount;
        BroadcastMessage("resetAttackTime");
    }
